...
export default function App({ Component, state }: PageProps) {
  return (
    <html>
      ...
      <body
        class="pt-12 flex min-h-screen"
        style="background: linear-gradient(15deg, #142850, #14365f, #13476f, #125d80, #107792, #0d96a5, #09b8b4, #04ccb1)"
      >
        <header class="fixed top-0 w-full text-white">
          <nav class="flex items-center p-3 relative">
            ...
            <div className="bg -z-10 absolute inset-0 scale-125 h-full w-full bg-slate-700 bg-opacity-75 blur-lg">
            </div>
          </nav>
        </header>
        <Component />
